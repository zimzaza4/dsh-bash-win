  ...
  return defineTool({
    ...
    async execute(args, exec) {
      ...
      if (backend === 'wsl') {
        ...
        if (wslPath === undefined) throw new Error(toolName + ': wsl.exe not found (looked in C:\\Windows\\System32)')
        ...
        if (bashPath === undefined) throw new Error(toolName + ': no Git Bash installation found')
